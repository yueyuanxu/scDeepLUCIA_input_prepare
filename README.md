...
Before running, generate pseudo-bulk ATAC bigWig files by following [scHiCAR downstream analysis codes](https://github.com/yueyuanxu/scHiCAR/tree/dev/5_downstream_analysis#23-generate-pvalue-bigwig-file-for-open-chromatin-visualization)
```bash
